...
import { deleteFeature } from "@/app/_services/apiFeatures";
...
const DeleteFeature = ({ feature }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <div>
          <h2 className="font-serif text-xl">Delete this Feature</h2>
          <div>
            <p className="mt-3">Are you sure you want to delete this feature</p>
            <p className="text-sm text-gray-800 mt-3">
              This will delete your feature permanently. You cannot undo this
              action.
            </p>
