...
export default function MyMap() {
  const isPermission = useCheckPermission("find_dealer");
        ...
        <div className="flex flex-col h-dvh w-dvw">
          <div className="find-store p-4 bg-white absolute max-w-[30rem] left-6 top-6 z-[99999]">
            <div>
              ...
              <h1 className="font-serif text-lg mb-2 uppercase">
                Find a store
              </h1>
              <form
              ...
              <div className="stores mt-4 h-[30rem] overflow-y-auto">
                ...
                {!isLoading && filteredStores.length === 0 ? (
                  ...
                  filteredStores?.map((store, i) => {
                    const storeCoordinates = getCoordinatesFromUrl(
                      store.map_url
                    );
